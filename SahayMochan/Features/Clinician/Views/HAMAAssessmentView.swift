...
struct HAMAAssessmentView: View {
    ...
    private var currentQuestion: ClinicalQuestion {
        HAMAAssessmentViewModel.questions[currentIndex]
    }

    private var isLastQuestion: Bool {
        currentIndex == HAMAAssessmentViewModel.questions.count - 1
    }
    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 20) {
                // Progress header
                HStack {
                    Text("Question \(currentIndex + 1) of \(HAMAAssessmentViewModel.questions.count)")
                        .font(.caption.bold())
                ...
                ProgressView(value: Double(currentIndex + 1), total: Double(HAMAAssessmentViewModel.questions.count))
